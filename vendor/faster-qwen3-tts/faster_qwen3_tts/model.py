...
class FasterQwen3TTS:
    ...
    def _get_speech_tokenizer(base_model):
        ...
        speech_tokenizer = getattr(base_model, "speech_tokenizer", None)
    ...
    def _infer_sample_rate(base_model) -> int:
        ...
        if sample_rate is None:
            logger.debug(
                "Could not infer sample rate from model internals; using 24000 Hz."
            )
            return 24000
    ...
    def from_pretrained(
        ...
        **model_kwargs,
        ...
        Args:
            ...
            **model_kwargs: Additional kwargs forwarded to qwen-tts /
